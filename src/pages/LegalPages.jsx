...
const pages = {
  terms: {
    ...
    description: 'The rules for using Ask Marketplace as a student, tutor, or visitor.',
    sections: [
      ['Acceptance of terms', 'By creating an account, browsing listings, posting a listing, booking a tutor, or otherwise using Ask Marketplace, you agree to these Terms of Service and our Privacy Policy. If you do not agree, do not use the platform.'],
      ['What Ask Marketplace does', 'Ask Marketplace helps students find tutors and other campus services, review listings, message providers, and request or coordinate sessions. We provide the marketplace tools; tutors and students are responsible for their own conduct and arrangements.'],
      ...
      ['Tutor accounts', 'Tutors must describe their services truthfully, keep availability current, honor confirmed sessions, and communicate clearly with students. Tutors are responsible for any qualifications, pricing, tax, payment, and scheduling information they provide.'],
      ['Tutor responsibility and independence', 'Tutors are independent users of the platform. Ask Marketplace does not employ tutors, supervise tutoring sessions, or guarantee any tutor’s credentials, conduct, availability, or results.'],
      ['Bookings', 'Booking requests may be pending, confirmed, completed, or cancelled. A booking is not final until accepted or confirmed through the platform or by clear communication between the student and tutor.'],
      ['Payments', 'Unless a specific in-platform payment feature is provided, payments are handled directly between students and tutors. Users are responsible for confirming price, payment method, and timing before a session.'],
      ['Cancellations and refunds', 'Cancellation, rescheduling, and refund outcomes depend on the timing, tutor policy, and facts of the situation. Ask Marketplace may review disputes, but direct payments may need to be resolved between the student, tutor, and payment provider.'],
      ...
      ['No guarantee of grades or outcomes', 'We do not guarantee grades, admissions results, test scores, course outcomes, tutor availability, or any particular academic or financial result.'],
      ...
      ['Limitation of liability', 'To the maximum extent allowed by law, Ask Marketplace is not liable for indirect, incidental, special, consequential, or punitive damages, or for disputes between students and tutors.'],
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Tutor profile information', 'Tutor profile information may include bio, subjects, courses, pricing, school affiliation, availability, profile images, payment handles, reviews, and listing details.'],
      ['Booking and session information', 'We process booking requests, availability, session status, messages, timestamps, and related support context so students and tutors can coordinate.'],
      ...
      ['Device, analytics, and cookie data', 'We collect privacy-conscious analytics such as page views, event names, referrers, UTM parameters, browser/device type, session identifiers, and approximate location if available from infrastructure.'],
      ...
      ['Student and tutor rights', 'Depending on your location, you may have rights to access, correct, delete, or receive a copy of certain personal information. Contact support to make a request.'],
  ...
  cookies: {
    ...
    sections: [
      ...
      ['Authentication/session cookies', 'Authentication tokens or session data keep you logged in and allow the app to show the correct student, tutor, or admin experience.'],
  ...
  refunds: {
    ...
    sections: [
      ['Cancellation window', 'Students and tutors should cancel as early as possible. If a tutor posts or communicates a cancellation policy, users should review it before booking.'],
      ...
      ['No-shows', 'If a student or tutor does not show up, document what happened in messages and contact support with the booking, time, and relevant details.'],
      ['Tutor cancellations', 'If a tutor cancels, they should notify the student promptly and help reschedule when possible. Repeated unreliable behavior may affect listing visibility or account standing.'],
      ['Refund review process', 'For payment disputes, send support the tutor name, booking date and time, amount, payment method, screenshots if relevant, and what outcome you are requesting.'],
  ...
  guidelines: {
    ...
    description: 'The behavior standards for students, tutors, and marketplace users.',
    sections: [
      ['Respectful communication', 'Be direct, respectful, and clear. Treat students, tutors, and admins like real people trying to coordinate quickly.'],
      ...
      ['No fraud, fake accounts, or impersonation', 'Do not create fake accounts, impersonate students or tutors, post false credentials, manipulate reviews, or misrepresent services.'],
      ['Tutor professionalism', 'Tutors should be prepared, punctual, honest about skill level, transparent about price, and responsive about availability and cancellations.'],
  ...
  return (
    <LegalShell kicker="Ask Marketplace">
      ...
      <p style={{ fontSize: 17, lineHeight: 1.65, color: 'var(--muted)', maxWidth: 720, marginBottom: 12 }}>
        Native Ask Marketplace policies for students, tutors, bookings, support, privacy, cookies, and community standards.
      </p>
      <p style={{ fontSize: 13, color: 'var(--muted)', marginBottom: 34 }}>
        Last updated: <strong style={{ color: 'var(--text)' }}>{LEGAL_LAST_UPDATED}</strong>
      </p>
