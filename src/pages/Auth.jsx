...
function SocialButtons({ redirect }) {
  ...
  const appleUrl  = `${API_ORIGIN}/auth/apple${params}`;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      <a href={appleUrl} style={{
        display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10,
        border: '1.5px solid #000', borderRadius: 9, padding: '10px 14px',
      ...
      >
        ...
        <svg width="16" height="18" viewBox="0 0 814 1000" fill="#fff">
          <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 790.7 0 663.3 0 541.8c0-207.8 109.8-317.9 217.9-317.9 67.7 0 124.4 44.5 167.3 44.5 41 0 105.6-47.3 183.9-47.3zm-256.4-144.2c31.2-36.9 53.5-88.1 53.5-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.1-71.3z"/>
        </svg>
        Sign in with Apple
      </a>
    </div>
